...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        movementContactFilter = BuilContactFilter2DForLayer(LayerMask.LayerToName(gameObject.layer));
    }
    ...
    private ContactFilter2D BuilContactFilter2DForLayer(string layerName) {
